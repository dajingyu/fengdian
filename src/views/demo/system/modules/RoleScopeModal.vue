<template>
  ...
  >
    <a-form :form="form">
      ...
      >
        <a-select v-decorator="['dataScope', {initialValue:'1'}]" @change="scopeChange" style="width: 228px">
...
<script>
  import { getRoleDeptIds, getDeptList } from '@/api/system'
  ...
  export default {
    ...
    created() {
      getDeptList().then(res => {
        this.buildtree(res.data, this.deptTree, '0')
      })
    },
    methods: {
      add() {
      ...
      handleOk(e) {
        ...
        this.form.validateFields((err, values) => {
          ...
          if (!err) {
            ...
            values.scopes =  this.checkedKeys
