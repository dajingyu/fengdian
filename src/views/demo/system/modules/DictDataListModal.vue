<template>
  ...
  >
    <div class="table-operator">
      <a-button v-if="addEnable" type="primary" icon="plus" @click="$refs.modal.add(dictTypeId)">新建</a-button>
...
export default {
  ...
  methods: {
    show (dictTypeId, dictType) {
      this.visible = true
      this.queryParam['dictType.id'] = dictTypeId
    ...
    handleEdit (record) {
      //内部不支持嵌入对象类型的存储 - 后续需要找到原因
      record = Object.assign({'dictType.id': this.dictTypeId }, record)
